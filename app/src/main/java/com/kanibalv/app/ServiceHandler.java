...
public class ServiceHandler {
    ...
    static String URL_GET_ROUTES = URL_SERVER + "getRoutes";
    static String URL_POST_TRACKS   = URL_SERVER +"postTracks";
    static String URL_POST_SESSIONS = URL_SERVER + "postSessions";
